...
- (void) showChatChooserFor:(iChatBuddy *)for_;  // displays a dialog in Messages to start a new chat with the specified buddy
...
@interface iChatApplication (MessagesSuite)
