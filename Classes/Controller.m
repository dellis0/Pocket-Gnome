...
- (void)checkWoWVersion {
	...
	[versionInfoText setStringValue: [NSString stringWithFormat: @"%@ v%@ may require WoW %@. You are running %@. Check the site below for more details.", [self appName], appVers, VALID_WOW_VERSION, [self wowVersionShort]]];
    }
}
